...
class Agent(object):
    ...
    def learn(self):
        ...
        avtion_indices = np.dot(action, action_values) # np.dot = dot product
        ...
        q_target[batch_index, action_indices] = reward + \ 
                self.gamma*np.max(q_next, axis=1)*done # best possible reward you could have received in the next state * done
